...
<div class="container-fluid nvwrap">
    ...
    <header id="header" class="row">
        <div class="logo">
            <a title="{NV_SITE_NAME}" href="{NV_BASE_SITEURL}{NV_ADMINDIR}/index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}">
                <img class="logo-md" alt="{NV_SITE_NAME}" src="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/images/logo_cpanel.png"  height="49"/>
                <img class="logo-xs" alt="{NV_SITE_NAME}" src="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/images/logo_cpanel.png" height="50"/>
            </a>
        </div>
    ...
    <footer id="footer" class="row">
        <div class="footer-content">
            ...
            <div class="imgstat">
                <a title="TMS Holdings" href="https://thuongmaiso.vn" target="_blank"><img alt="TMS Holdings" src="{NV_BASE_SITEURL}themes/{NV_ADMIN_THEME}/images/logo_cpanel.png"  height="15" /></a>
                <br/>
            </div>
        </div>
    </footer>
